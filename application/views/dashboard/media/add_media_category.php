			...
			<div class="container m-4 p-4 border-radius-2 nested-dashboard-working-area">
				...
				<div class="row flex-col dashboard-widget-container align-items-y">
					<div class="col ds-col-6 dashboard-widget">
						...
						<?=form_open('dashboard/media/settings/add-category','')?>
								...
								<div class="container">
									<div class="row">
										...
										<div class="form-element flex-col">
											<input class="btn-rect-rounded border-soft px-5" type="submit" name="submit" value="Add Media Category">
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	{	
		...
		var url = 'commons/common/get-childs/media/'+parent_id+'/1';
