	...
	<div class="row flex-col dashboard-widget-container align-items-y">
		<div class="col ds-col-6 dashboard-widget">
			<div class="container">
				...
				<?=form_open('dashboard/shop-setting/location/add/country','')?>
						...
						<div class="row ds-row-cols-12 flex px-child-1 space-between mb-child-3">
							...
							<div class="col">
								<div class="form-element flex-col mr-4 mt-0">
									...
									<input class="mb-2 p-3" type="text" name="country_name" value="<?= set_value('country_name')?>">
								</div>
							</div>
							<!--country code-->
							<div class="col">
								<div class="form-element flex-col mr-4 mt-0">
									...
									<input class="mb-2 p-3" type="text" name="country_code" value="<?= set_value('country_code')?>">
								</div>
							</div>
							<!--currency code-->
							<div class="col">
								<div class="form-element flex-col mr-4 mt-0">
									...
									<input class="mb-2 p-3" type="text" name="currency_code" value="<?= set_value('currency_code')?>">
								</div>
							</div>
							<!--country symbol-->
							<div class="col">
								<div class="form-element flex-col mr-4 mt-0">
									...
									<input class="mb-2 p-3" type="text" name="currency_symbol" value="<?= set_value('currency_symbol')?>">
								</div>
							</div>
						</div>
